...
use naia_shared::{BigMapKey, ChannelIndex, ExternalEntity, Protocolize};
...
pub struct UserRef<'s, P: Protocolize, E: ExternalEntity + Send + Sync, C: ChannelIndex> {
    server: &'s Server<P, E, C>,
    key: UserKey,
}

impl<'s, P: Protocolize, E: ExternalEntity + Send + Sync, C: ChannelIndex> UserRef<'s, P, E, C> {
...
// UserMut
pub struct UserMut<'s, P: Protocolize, E: ExternalEntity + Send + Sync, C: ChannelIndex> {
    server: &'s mut Server<P, E, C>,
    key: UserKey,
}

impl<'s, P: Protocolize, E: ExternalEntity + Send + Sync, C: ChannelIndex> UserMut<'s, P, E, C> {
